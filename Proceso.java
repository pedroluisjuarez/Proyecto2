...
public class Proceso {
    ...
    private Pagmemoria tablaPagina[];
    ...
    public Proceso(int idProceso, String nombre, int tamaño, int tamañoPagina) {
        ...
        this.tablaPagina = new Pagmemoria[this.cantidadPaginas];
        crearPaginas();    }
    
    private void crearPaginas() {
        for(int i = 0; i < cantidadPaginas; i++) {
            this.tablaPagina[i] = new Pagmemoria(idProceso, nombre, i, null);
        }    }
    ...
    public Pagmemoria[] getTablaPagina() {
        return tablaPagina;}

    public void setTablaPagina(Pagmemoria[] tablaPagina) {
